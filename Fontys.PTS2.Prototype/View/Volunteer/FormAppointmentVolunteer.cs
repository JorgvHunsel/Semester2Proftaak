...
{
    public partial class FormAppointmentVolunteer : Form
    {
        private int _careRecipientID;
        private int _volunteerID;
        private int _questionID;

        public FormAppointmentVolunteer(int questionID, int careRecipientID, int volunteerID, string careRecipientName)
        {
            InitializeComponent();
